      ...
      <ConstrainedBox classNames="px-4 py-8 pt-16 z-20 items-center justify-center">
        <Column classNames="w-full items-center justify-center">
          ...
          <p className="text-sm/normal md:text-base/normal dark:text-[var(--textColorLight)] text-[var(--textColorLight)]">
            Senior Software Engineer at NRS ,specializing in product and application development with expertise in cloud architecture.
            I am a motivated and flexible professional who enjoys taking on challenges and learning new things. My eagerness to grow helps me quickly pick up new skills and technologies, allowing me to create innovative solutions and go beyond expectations. With a positive attitude and dedication to quality,
            I see every project as an opportunity to make a difference. 
            My problem-solving skills and adaptability help me work well in fast-paced environments and contribute to team success 💻 🛠️ 🌍.
          </p>
        </Column>
